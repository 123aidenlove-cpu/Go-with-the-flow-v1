...
interface AdventureAlertsModalProps {
  onClose: () => void;
}

export default function AdventureAlertsModal({ onClose }: AdventureAlertsModalProps) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/80 backdrop-blur-md p-4">
      <div className="bg-white rounded-[2rem] p-8 max-w-4xl w-full flex flex-col shadow-2xl relative border-4 border-indigo-200 overflow-y-auto max-h-[90vh]">
        <button 
          onClick={onClose}
          className="absolute top-6 right-6 text-slate-400 hover:text-slate-600 font-bold bg-slate-100 p-3 rounded-full transition-colors"
        >
          <X className="w-6 h-6" />
        </button>
        <h2 className="text-4xl font-black text-indigo-900 mb-8 flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Teacher Task 1 */}
          <div className="bg-orange-50 border-2 border-orange-200 p-6 rounded-3xl flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
          ...
          {/* App Task 1 */}
          <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-3xl flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-white p-4 rounded-2xl border border-blue-100 mt-auto flex justify-between items-center shadow-sm">
              ...
              <span className="text-blue-600 font-black">+20 Quavits</span>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border-2 border-blue-200 p-6 rounded-3xl flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-white p-4 rounded-2xl border border-blue-100 mt-auto flex justify-between items-center shadow-sm">
              ...
              <span className="text-blue-600 font-black">+40 Quavits</span>
            </div>
          </div>
        </div>
      </div>
